      ...
      <div class="vehicle-card" onclick="viewVehicle(${v.id})">
        ...
        <div class="vehicle-info">
          ...
          <div class="vehicle-meta">
            <span><svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="10" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>${v.mileage === 0 ? '<span class="badge-nuevo">0 km · NUEVO</span>' : formatNumber(v.mileage || 0) + ' km'}</span>
